...
[id="fileID"] soup-html.js soup-body.testClass span.someClass {background-color: red; --custom-property: url('what-is-this/image.png')}@font-face {
    font-family: "Stix";
    font-weight: normal;
    font-style: normal;
